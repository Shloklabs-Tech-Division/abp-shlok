...
namespace Shlok.Framework.ui.frontend.primary.Themes.ShlokFramework.Components.Toolbar
{
    public class MainNavbarToolbarViewComponent : AbpViewComponent
    {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            return View("~/Themes/ShlokFramework/Components/Toolbar/Default.cshtml", toolbar);
        }
    }
}
